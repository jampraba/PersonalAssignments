...
@Test(dataProvider="jamudata")
	public void salesforce(String Name,String Companyname,String Description) throws InterruptedException {
	//- Click on the toggle menu button from the left corner
		...
		WebElement jam = driver.findElement(By.xpath("(//input[@class='slds-input'])[2]"));
		jam.sendKeys(Name);
		Thread.sleep(3000);
